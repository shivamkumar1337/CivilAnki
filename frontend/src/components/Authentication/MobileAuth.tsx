        ...
        >
          ...
          {/* <View style={styles.debugContainer}>
            <Text style={styles.debugText}>
              Debug: Mobile: "{mobile}" | Length: {mobile.length} | Valid: {isValid ? 'YES' : 'NO'}
            </Text>
            <Text style={styles.debugText}>
              First digit: {mobile[0] || 'none'} | Starts with valid digit: {['6','7','8','9'].includes(mobile[0]) ? 'YES' : 'NO'}
            </Text>
          </View> */}
          ...
          {/* <View style={styles.featuresSection}>
            ...
            <View style={styles.featuresList}>
              ...
              <View style={styles.featureItem}>
                ...
                <Text style={styles.featureText}>Goal-based learning paths</Text>
              </View>
            </View>
          </View> */}
